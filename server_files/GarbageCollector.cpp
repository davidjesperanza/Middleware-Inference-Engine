...
void GarbageCollector::addConnection(Connection * connection) { // Add a new connection
...
void GarbageCollector::cleanup() {// Clean up all finished threads
 ...
 for ( ; cur!= NULL && !cur->isRunning(); ) { // Loop and delete all finished connection from the front of the list
